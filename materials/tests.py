...
class LessonSubscriptionTestCase(APITestCase):
    ...
    def test_user_subscribe(self):
        ...
        url = reverse(
            "users:subscription"
        )  # пример namespace 'users' и имя маршрута 'subscription'
    ...
    def test_create_lesson_invalid_url(self):
        ...
        self.assertEqual(
            response.json(),
            {"link_to_video": ["Ссылка должна вести на ресурсы: 'youtube.com'"]},
        )
    ...
    def test_update_lesson(self):
        ...
        data = {"title": "test_test", "link_to_video": "www.youtube.com"}
